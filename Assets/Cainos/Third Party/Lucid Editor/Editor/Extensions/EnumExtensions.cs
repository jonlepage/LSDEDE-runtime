    ...
    public static class InspectorColorExtensions
    {
        public static Color ToColor(this InspectorColor color)
        {
            switch (color)
            {
                ...
                case InspectorColor.Cyan:
                    return Color.cyan;
                case InspectorColor.Magenta:
                ...
                case InspectorColor.Gray:
                    return Color.gray;
                case InspectorColor.Grey:
                    return Color.grey;
                case InspectorColor.Black:
                    return Color.black;
                case InspectorColor.EditorText:
                    return EditorColors.text;
                case InspectorColor.EditorTextSelected:
                    return EditorColors.textSelected;
                case InspectorColor.EditorBackground:
                    return EditorColors.background;
                case InspectorColor.EditorLine:
                    return EditorColors.line;
                case InspectorColor.EditorThinLine:
                    return EditorColors.thinLine;
                case InspectorColor.EditorWarning:
                    return EditorColors.warning;
                case InspectorColor.EditorError:
