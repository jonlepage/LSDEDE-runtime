...
namespace Cainos.LucidEditor
{
    public static class LucidEditorGUI
    {
        ...
        public static T Field<T>(Rect position, GUIContent label, T value)
        {
            ...
            {
                case int intValue:
                    return GenericTypeConverter<T>.Convert<int>(
                        IntField(position, label, intValue)
                    );
                case long longValue:
                    return GenericTypeConverter<T>.Convert<long>(
                        LongField(position, label, longValue)
                    );
                case float floatValue:
                    return GenericTypeConverter<T>.Convert<float>(
                        FloatField(position, label, floatValue)
                    );
                case double doubleValue:
                    return GenericTypeConverter<T>.Convert<double>(
                        DoubleField(position, label, doubleValue)
                    );
                case bool boolValue:
                    return GenericTypeConverter<T>.Convert<bool>(
                        Toggle(position, label, boolValue)
                    );
                case string stringValue:
                    return GenericTypeConverter<T>.Convert<string>(
                        TextField(position, label, stringValue)
                    );
                case Vector2Int vector2IntValue:
                    return GenericTypeConverter<T>.Convert<Vector2Int>(
                        Vector2IntField(position, label, vector2IntValue)
                    );
                case Vector2 vector2Value:
                    return GenericTypeConverter<T>.Convert<Vector2>(
                        Vector2Field(position, label, vector2Value)
                    );
                case Vector3Int vector3IntValue:
                    return GenericTypeConverter<T>.Convert<Vector3Int>(
                        Vector3IntField(position, label, vector3IntValue)
                    );
                case Vector3 vector3Value:
                    return GenericTypeConverter<T>.Convert<Vector3>(
                        Vector3Field(position, label, vector3Value)
                    );
                case Vector4 vector4Value:
                    return GenericTypeConverter<T>.Convert<Vector3>(
                        Vector4Field(position, label, vector4Value)
                    );
                case RectInt rectIntValue:
                    return GenericTypeConverter<T>.Convert<RectInt>(
                        RectIntField(position, label, rectIntValue)
                    );
                case Rect rectValue:
                    return GenericTypeConverter<T>.Convert<Rect>(
                        RectField(position, label, rectValue)
                    );
                case BoundsInt boundsIntValue:
                    return GenericTypeConverter<T>.Convert<BoundsInt>(
                        BoundsIntField(position, label, boundsIntValue)
                    );
                case Bounds boundsValue:
                    return GenericTypeConverter<T>.Convert<Bounds>(
                        BoundsField(position, label, boundsValue)
                    );
                case Color colorValue:
                    return GenericTypeConverter<T>.Convert<Color>(
                        ColorField(position, label, colorValue)
                    );
                case Gradient gradientValue:
                    return GenericTypeConverter<T>.Convert<Gradient>(
                        GradientField(position, label, gradientValue)
                    );
                case Enum enumValue:
                    return GenericTypeConverter<T>.Convert<Enum>(
                        EnumPopup(position, label, enumValue)
                    );
                case AnimationCurve animationCurveValue:
                    return GenericTypeConverter<T>.Convert<AnimationCurve>(
                        CurveField(position, label, animationCurveValue)
                    );
                case Object objectValue:
                    return GenericTypeConverter<T>.Convert<Object>(
                        ObjectField(position, label, objectValue, objectValue.GetType(), true)
                    );
            }
        ...
        public static void MultiPropertyField(
            Rect position,
        ...
        public static string TextField(Rect position, string label, string value, GUIStyle style) =>
            EditorGUI.TextField(position, label, value, style);
        ...
        public static string DelayedTextField(
            ...
            string value,
            GUIStyle style
        ) => EditorGUI.DelayedTextField(position, label, value, style);
        ...
        public static string PasswordField(
            ...
            string password,
            GUIStyle style
        ) => EditorGUI.PasswordField(position, label, password, style);
        ...
        public static int IntField(Rect position, int value, GUIStyle style) =>
            EditorGUI.IntField(position, value, style);
        ...
        public static int IntField(Rect position, string label, int value, GUIStyle style) =>
            EditorGUI.IntField(position, label, value, style);
        ...
        public static int IntPopup(
            ...
            int[] optionValues
        ) => EditorGUI.IntPopup(position, selectedValue, displayedOptions, optionValues);
        ...
        public static int IntPopup(
            ...
            int[] optionValues,
            GUIStyle style
        ) => EditorGUI.IntPopup(position, selectedValue, displayedOptions, optionValues, style);
        ...
        public static int IntPopup(
            ...
            string[] displayedOptions,
            int[] optionValues
        ) => EditorGUI.IntPopup(position, label, selectedValue, displayedOptions, optionValues);
        ...
        public static int IntSlider(Rect position, int value, int leftValue, int rightValue) =>
            EditorGUI.IntSlider(position, value, leftValue, rightValue);
        ...
        public static int IntSlider(
            ...
            int leftValue,
            int rightValue
        ) => EditorGUI.IntSlider(position, label, value, leftValue, rightValue);
        ...
        public static float FloatField(Rect position, string label, float value, GUIStyle style) =>
            EditorGUI.FloatField(position, label, value, style);
        ...
        public static float FloatSlider(
            ...
            float leftValue,
            float rightValue
        ) => EditorGUI.Slider(position, value, leftValue, rightValue);
        ...
        public static float FloatSlider(
            ...
            float leftValue,
            float rightValue
        ) => EditorGUI.Slider(position, label, value, leftValue, rightValue);
        ...
        public static float DelayedFloatField(
            ...
            float value,
            GUIStyle style
        ) => EditorGUI.DelayedFloatField(position, label, value, style);
        ...
        public static double DoubleField(
            ...
            double value,
            GUIStyle style
        ) => EditorGUI.DoubleField(position, label, value, style);
        ...
        public static double DelayedDoubleField(
            ...
            double value,
            GUIStyle style
        ) => EditorGUI.DelayedDoubleField(position, label, value, style);
        ...
        public static long LongField(Rect position, long value) =>
            EditorGUI.LongField(position, value);

        public static long LongField(Rect position, long value, GUIStyle style) =>
            EditorGUI.LongField(position, value, style);
        ...
        public static long LongField(Rect position, string label, long value, GUIStyle style) =>
            EditorGUI.LongField(position, label, value, style);
        ...
        public static bool Toggle(Rect position, bool value, GUIStyle style) =>
            EditorGUI.Toggle(position, value, style);
        ...
        public static bool Toggle(Rect position, string label, bool value, GUIStyle style) =>
            EditorGUI.Toggle(position, label, value, style);
        ...
        public static bool ToggleLeft(Rect position, string label, bool value, GUIStyle style) =>
            EditorGUI.ToggleLeft(position, label, value, style);
        ...
        public static Vector2 Vector2Field(Rect position, string label, Vector2 value) =>
            EditorGUI.Vector2Field(position, label, value);
        ...
        public static Vector2Int Vector2IntField(Rect position, string label, Vector2Int value) =>
            EditorGUI.Vector2IntField(position, label, value);

        public static Vector2Int Vector2IntField(
            Rect position,
            GUIContent label,
            Vector2Int value
        ) => EditorGUI.Vector2IntField(position, label, value);
        ...
        public static Vector3 Vector3Field(Rect position, string label, Vector3 value) =>
            EditorGUI.Vector3Field(position, label, value);
        ...
        public static Vector3Int Vector3IntField(Rect position, string label, Vector3Int value) =>
            EditorGUI.Vector3IntField(position, label, value);

        public static Vector3Int Vector3IntField(
            Rect position,
            GUIContent label,
            Vector3Int value
        ) => EditorGUI.Vector3IntField(position, label, value);
        ...
        public static Vector4 Vector4Field(Rect position, string label, Vector4 value) =>
            EditorGUI.Vector4Field(position, label, value);
        ...
        public static Color ColorField(
            ...
            bool showAlpha,
            bool hdr
        ) => EditorGUI.ColorField(position, label, value, showEyedropper, showAlpha, hdr);

        public static Gradient GradientField(Rect position, Gradient gradient) =>
            EditorGUI.GradientField(position, gradient);

        public static Gradient GradientField(Rect position, string label, Gradient gradient) =>
            EditorGUI.GradientField(position, label, gradient);

        public static Gradient GradientField(Rect position, GUIContent label, Gradient gradient) =>
            EditorGUI.GradientField(position, label, gradient);

        public static Gradient GradientField(
            Rect position,
            GUIContent label,
            Gradient gradient,
            bool hdr
        ) => EditorGUI.GradientField(position, label, gradient, hdr);
        ...
        public static AnimationCurve CurveField(
            ...
            Color color,
            Rect ranges
        ) => EditorGUI.CurveField(position, label, value, color, ranges);
        ...
        public static Bounds BoundsField(Rect position, Bounds value) =>
            EditorGUI.BoundsField(position, value);

        public static Bounds BoundsField(Rect position, string label, Bounds value) =>
            EditorGUI.BoundsField(position, label, value);
        ...
        public static BoundsInt BoundsIntField(Rect position, BoundsInt value) =>
            EditorGUI.BoundsIntField(position, value);

        public static BoundsInt BoundsIntField(Rect position, string label, BoundsInt value) =>
            EditorGUI.BoundsIntField(position, label, value);
        ...
        public static Rect RectField(Rect position, Rect value) =>
            EditorGUI.RectField(position, value);

        public static Rect RectField(Rect position, string label, Rect value) =>
            EditorGUI.RectField(position, label, value);
        ...
        public static RectInt RectIntField(Rect position, RectInt value) =>
            EditorGUI.RectIntField(position, value);

        public static RectInt RectIntField(Rect position, string label, RectInt value) =>
            EditorGUI.RectIntField(position, label, value);
        ...
        public static Enum EnumFlagsField(Rect position, Enum enumValue) =>
            EditorGUI.EnumFlagsField(position, enumValue);

        public static Enum EnumFlagsField(Rect position, Enum enumValue, GUIStyle style) =>
            EditorGUI.EnumFlagsField(position, enumValue, style);

        public static Enum EnumFlagsField(Rect position, string label, Enum enumValue) =>
            EditorGUI.EnumFlagsField(position, label, enumValue);

        public static Enum EnumFlagsField(
            Rect position,
            string label,
            Enum enumValue,
            GUIStyle style
        ) => EditorGUI.EnumFlagsField(position, label, enumValue, style);
        ...
        ) => EditorGUI.EnumFlagsField(position, label, enumValue, includeObsolete);
        ...
        public static Enum EnumFlagsField(
            ...
            bool includeObsolete,
            GUIStyle style
        ) => EditorGUI.EnumFlagsField(position, label, enumValue, includeObsolete, style);

        public static TEnum EnumFlagsField<TEnum>(Rect position, TEnum enumValue)
            where TEnum : Enum => (TEnum)EditorGUI.EnumFlagsField(position, enumValue);

        public static TEnum EnumFlagsField<TEnum>(Rect position, TEnum enumValue, GUIStyle style)
            where TEnum : Enum => (TEnum)EditorGUI.EnumFlagsField(position, enumValue, style);

        public static TEnum EnumFlagsField<TEnum>(Rect position, string label, TEnum enumValue)
            where TEnum : Enum => (TEnum)EditorGUI.EnumFlagsField(position, label, enumValue);

        public static TEnum EnumFlagsField<TEnum>(
            Rect position,
            string label,
            TEnum enumValue,
            GUIStyle style
            ...
            where TEnum : Enum =>
            (TEnum)EditorGUI.EnumFlagsField(position, label, enumValue, style);
        ...
        public static TEnum EnumFlagsField<TEnum>(
            ...
            where TEnum : Enum =>
            (TEnum)EditorGUI.EnumFlagsField(position, label, enumValue, includeObsolete);
        ...
        public static Enum EnumPopup(
            ...
            bool includeObsolete
        ) => EditorGUI.EnumPopup(position, label, selected, checkEnabled, includeObsolete);
        ...
        public static Enum EnumPopup(
            ...
            bool includeObsolete,
            GUIStyle style
        ) => EditorGUI.EnumPopup(position, label, selected, checkEnabled, includeObsolete, style);

        public static TEnum EnumPopup<TEnum>(Rect position, TEnum selected)
            where TEnum : Enum => (TEnum)EditorGUI.EnumPopup(position, selected);

        public static TEnum EnumPopup<TEnum>(Rect position, TEnum selected, GUIStyle style)
            where TEnum : Enum => (TEnum)EditorGUI.EnumPopup(position, selected, style);

        public static TEnum EnumPopup<TEnum>(Rect position, string label, TEnum selected)
            where TEnum : Enum => (TEnum)EditorGUI.EnumPopup(position, label, selected);

        public static TEnum EnumPopup<TEnum>(
            Rect position,
            string label,
            TEnum selected,
            GUIStyle style
        )
            where TEnum : Enum => (TEnum)EditorGUI.EnumPopup(position, label, selected, style);
        ...
        public static TEnum EnumPopup<TEnum>(
            ...
            where TEnum : Enum =>
            (TEnum)EditorGUI.EnumPopup(position, label, selected, checkEnabled, includeObsolete);
        ...
        ) => EditorGUI.ObjectField(position, obj, objType, allowSceneObjects);
        ...
        public static Object ObjectField(
            ...
            Type objType,
            bool allowSceneObjects
        ) => EditorGUI.ObjectField(position, label, obj, objType, allowSceneObjects);
        ...
        public static T ObjectField<T>(Rect position, T obj, bool allowSceneObjects)
            where T : Object =>
            (T)EditorGUI.ObjectField(position, obj, typeof(T), allowSceneObjects);

        public static T ObjectField<T>(Rect position, string label, T obj, bool allowSceneObjects)
            where T : Object =>
            (T)EditorGUI.ObjectField(position, label, obj, typeof(T), allowSceneObjects);
        ...
        public static void ObjectField<T>(
            Rect position,
            SerializedProperty property,
            GUIContent label
        ...
        public static int MaskField(
            Rect position,
            GUIContent label,
            int mask,
            string[] displayedOptions
        ) => EditorGUI.MaskField(position, label, mask, displayedOptions);
        ...
        public static int MaskField(
            ...
            string[] displayedOptions,
            GUIStyle style
        ) => EditorGUI.MaskField(position, label, mask, displayedOptions, style);
        ...
        public static int MaskField(Rect position, int mask, string[] displayedOptions) =>
            EditorGUI.MaskField(position, mask, displayedOptions);
        ...
        public static int MaskField(
            ...
            string[] displayedOptions,
            GUIStyle style
        ) => EditorGUI.MaskField(position, mask, displayedOptions, style);

        public static int Popup(Rect position, int selectedIndex, string[] displayedOptions) =>
            EditorGUI.Popup(position, selectedIndex, displayedOptions);
        ...
        public static int Popup(
            ...
            string[] displayedOptions,
            GUIStyle style
        ) => EditorGUI.Popup(position, selectedIndex, displayedOptions, style);
        ...
        public static int Popup(
            ...
            int selectedIndex,
            string[] displayedOptions
        ) => EditorGUI.Popup(position, label, selectedIndex, displayedOptions);
        ...
        public static int Popup(
            ...
            string[] displayedOptions,
            GUIStyle style
        ) => EditorGUI.Popup(position, label, selectedIndex, displayedOptions, style);
        ...
        public static Rect PrefixLabel(Rect totalPosition, GUIContent label, GUIStyle style) =>
            EditorGUI.PrefixLabel(totalPosition, label, style);

        public static Rect PrefixLabel(Rect totalPosition, int id, GUIContent label) =>
            EditorGUI.PrefixLabel(totalPosition, id, label);
        ...
        public static Rect PrefixLabel(
            ...
            GUIContent label,
            GUIStyle style
        ) => EditorGUI.PrefixLabel(totalPosition, id, label, style);

        public static void HandlePrefixLabel(
            Rect totalPosition,
            Rect labelPosition,
            GUIContent label
        ...
        public static bool InspectorTitlebar(
            Rect position,
            bool foldout,
            Object targetObj,
            bool expandable
        ) => EditorGUI.InspectorTitlebar(position, foldout, targetObj, expandable);
        ...
        public static bool InspectorTitlebar(
            ...
            Object[] targetObjs,
            bool expandable
        ) => EditorGUI.InspectorTitlebar(position, foldout, targetObjs, expandable);
        ...
        public static bool Foldout(Rect position, bool foldout, string content) =>
            EditorGUI.Foldout(position, foldout, content);

        public static bool Foldout(Rect position, bool foldout, string content, GUIStyle style) =>
            EditorGUI.Foldout(position, foldout, content, style);
        ...
        ) => EditorGUI.Foldout(position, foldout, content, toggleOnLabelClick);
        ...
        public static bool Foldout(
            ...
            bool toggleOnLabelClick,
            GUIStyle style
        ) => EditorGUI.Foldout(position, foldout, content, toggleOnLabelClick, style);
        ...
        public static bool FolderFoldout(
            Rect position,
            bool foldout,
            string text,
        ...
        )
        {
            GUIContent folderContent = foldout
                ? EditorIcons.FolderOpenedIcon
                : EditorIcons.FolderIcon;
        ...
        public static bool FoldoutHeader(Rect position, bool foldout, string content) =>
            EditorGUI.Foldout(position, foldout, content, EditorStyles.foldoutHeader);
        ...
        public static bool RepeatButton(
            Rect position,
            string content,
            GUIStyle style,
            Action action
        ...
        public static bool RepeatButton(Rect position, Texture image) =>
            GUI.RepeatButton(position, image);
        ...
        public static bool RepeatButton(Rect position, Texture image, GUIStyle style) =>
            GUI.RepeatButton(position, image, style);
        ...
        {
            return SectionFoldout(
                position,
                foldout,
                label,
                EditorColors.helpBox,
                EditorColors.thinLine,
                true
            );
        }
        ...
        public static bool SectionFoldout(
            Rect position,
            bool foldout,
            string label,
            bool toggleOnLabelClick
        ...
        private static void DrawSectionHeaderArea(
            Rect position,
            Color backgroundColor,
            Color lineColor
        )
        ...
        )
        {
            return GUI.Toolbar(
                position,
                selectedIndex,
                displayedOptions.Select(x => new GUIContent(x)).ToArray(),
                "LargeButton",
                toolbarButtonSize
            );
        }
        ...
        public static GUIContent BeginProperty(
            Rect totalPosition,
            GUIContent label,
            SerializedProperty property
        )
